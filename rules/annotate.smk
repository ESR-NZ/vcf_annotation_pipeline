...
rule VEP:
    input:
        vcf = "annotated/{sample}.vqsr.recal.dbnsfp.vcf"
    output:
        report("{sample}.vqsr.recal.dbnsfp.vep.vcf_summary.txt", caption = "../report/annotation.rst", category = "Variant effect predictor"),
        report("{sample}.vqsr.recal.dbnsfp.vep.vcf_warnings.txt", caption = "../report/annotation.rst", category = "Variant effect predictor"),
